...
public class ErtlFunctionalGroupsFinderTestOld extends CDKTestCase {

    public ErtlFunctionalGroupsFinderTestOld() {
        super();
    }
...
//        fGs = fgFinder.expandGeneralizedEnvironments(fGs);
		List<IAtomContainer> fGs = fgFinder.find(mol, true);
...
//					List<IAtomContainer> fGs = fgFinder.extractGroups(mol);
//					fGs = fgFinder.expandGeneralizedEnvironments(fGs);
					List<IAtomContainer> fGs = fgFinder.find(mol, false);
				}
			}
...
//            fGs = fgFinder.expandGeneralizedEnvironments(fGs);
			List<IAtomContainer> fGs = fgFinder.find(aC, false);
